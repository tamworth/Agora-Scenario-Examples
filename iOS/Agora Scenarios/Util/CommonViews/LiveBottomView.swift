...
class LiveBottomView: UIView {
    ...
    private lazy var chatButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(onTapChatButton), for: .touchUpInside)
...
//        chatButton.widthAnchor.constraint(equalToConstant: 100.fit).isActive = true
    ...
    private func createBottomButton() {
        ...
        type.forEach({
            ...
            button.addTarget(self, action: #selector(onTapButtonHandler(sender:)), for: .touchUpInside)
...
//        ToastView.show(text: "没实现")
    ...
    private func onTapButtonHandler(sender: UIButton) {
        ...
        onTapBottomButtonTypeClosure?(buttonType)
    }
}
