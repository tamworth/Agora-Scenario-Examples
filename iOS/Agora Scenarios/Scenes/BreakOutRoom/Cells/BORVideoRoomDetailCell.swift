...
class BORVideoRoomDetailCell: UICollectionViewCell {
    var onTapMuteButtonClosure: ((Bool) -> Void)?
    ...
    private lazy var volumeButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(onTapMuteButton), for: .touchUpInside)
    ...
    @objc
    private func onTapMuteButton(sender: UIButton) {
        sender.isSelected = !sender.isSelected
        onTapMuteButtonClosure?(sender.isSelected)
    }
}
