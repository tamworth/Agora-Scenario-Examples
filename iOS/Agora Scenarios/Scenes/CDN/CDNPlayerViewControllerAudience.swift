...
class CDNPlayerViewControllerAudience: BaseViewController {
    ...
    public init(config: Config) {
        ...
        self.config = config
        pushUrlString = "rtmp://examplepush.agoramde.agoraio.cn/live/" + config.sceneId
        pullUrlString = "http://examplepull.agoramde.agoraio.cn/live/\(config.sceneId).flv"

        let userId = CDNStorageManager.uuid
        let userName = CDNStorageManager.userName
        syncUtil = CDNSyncUtil(appId: config.appId,
